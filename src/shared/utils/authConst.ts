...
// The config needed to establish the connection.
export const IDENTITY_CONFIG = {
    ...
    audience: "http://localhost:3000", //is there a way to specific the audience when making the jwt
...
// The extra info that you want to have in the token.
